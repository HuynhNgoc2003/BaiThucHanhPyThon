...
if __name__=="__main__":
    ...
    heading = Label(root, text="THÔNG TIN ĐĂNG KÝ HỌC PHẦN", bg="light blue", fg="red", font=("Arial", 15, "bold")).place(x=120, y=5)

    mssv = Label(root, text="Mã số sinh viên", bg="light blue").place(x=10, y=30)
 
    # tạo label "Họ tên"
    hoten = Label(root, text="Họ tên", bg="light blue").place(x=10, y=50)
 
    # tạo label "ngày sinh"
    ngaysinh = Label(root, text="Ngày sinh", bg="light blue").place(x=10, y=70)
 
    # tạo label "Email"
    email = Label(root, text="Email", bg="light blue").place(x=10, y=90)
 
    # tạo label "Số điện thoại"
    sdt = Label(root, text="Số điện thoại", bg="light blue").place(x=10, y=110)
 
    # Tạo label "Học kỳ"
    hocky = Label(root, text="Học kỳ", bg="light blue").place(x=10, y=130)
 
    # Tạo label "năm học"
    namhoc = Label(root, text="Năm học", bg="light blue").place(x=10, y=150)
    # tạo label "Chọn môn học"
    chonmonhoc = Label(root, text="Chọn môn học", bg="light blue").place(x=10, y=170)
